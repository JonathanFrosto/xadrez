...
public class ChessMatch {
    ...
    private Piece makeMove(Position source, Position target) {
        ...
        if (sourcePiece instanceof King && target.getColumn() == source.getColumn() + 2) {
            ...
            ChessPiece rook = (ChessPiece) board.removeAPiece(sourceT);
        ...
        if (sourcePiece instanceof Pawn) {
            if (source.getColumn() != target.getColumn() && capturedPiece == null) {
                ...
                capturedPiece = board.removeAPiece(pawnPosition);
                capturedPieces.add(capturedPiece);
                piecesOnTheBoard.remove(capturedPiece);
            }
        }
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece) {
        ...
        if (p instanceof King && target.getColumn() == source.getColumn() + 2) {
            Position sourceT = new Position(source.getRow(), source.getColumn() + 3);
            Position targetT = new Position(source.getRow(), source.getColumn() + 1);
            ChessPiece rook = (ChessPiece) board.removeAPiece(targetT);
        ...
        if (p instanceof Pawn) {
            if (source.getColumn() != target.getColumn() && capturedPiece == enPassant) {
                ChessPiece pawn = (ChessPiece) board.removeAPiece(target);
                Position pawnPosition;
    ...
    public ChessPiece replacePromotedPiece(String type) {
        ...
        Piece p = board.removeAPiece(pos);
